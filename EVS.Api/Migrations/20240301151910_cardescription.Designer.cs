...
namespace EVS.Api.Migrations
{
    ...
    [Migration("20240301151910_cardescription")]
            ...
            modelBuilder.Entity("EVS.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("54823d83-934f-4735-b4ea-06d9b3a283ac"),
                            Birthday = new DateTime(2024, 3, 1, 16, 19, 10, 3, DateTimeKind.Local).AddTicks(3702),
                            CarDescription = "",
